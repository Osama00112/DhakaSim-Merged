...
public class Segment {
	...
	public void draw(Graphics2D g2d) {
		...
		g2d.setColor(Constants.ROAD_BORDER_COLOR);
		...
		w = footpathStripWidth * pixelPerMeter;
		x3 = (int) round(returnX3(x1, y1, x2, y2, w));
		y3 = (int) round(returnY3(x1, y1, x2, y2, w));
		x4 = (int) round(returnX4(x1, y1, x2, y2, w));
		y4 = (int) round(returnY4(x1, y1, x2, y2, w));
		g2d.drawLine(x3, y3, x4, y4);

		w = (segmentWidth-footpathStripWidth) * pixelPerMeter;
		x3 = (int) round(returnX3(x1, y1, x2, y2, w));
		y3 = (int) round(returnY3(x1, y1, x2, y2, w));
		x4 = (int) round(returnX4(x1, y1, x2, y2, w));
		y4 = (int) round(returnY4(x1, y1, x2, y2, w));
