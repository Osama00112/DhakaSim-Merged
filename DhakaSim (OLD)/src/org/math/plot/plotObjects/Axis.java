 ...
 * BSD License
 *
 * @author Yann RICHET Changed on 6/13/2014 by Jerry Dietrich Contact info
 * ballooninternet@cox.net
 */
public class Axis implements Plotable, BaseDependant, Editable {
    ...
    protected Font lightLabelFont = new Font("Times New Roman", Font.PLAIN, 15);
    ...
    public void setLightLabels() {
        ...
        for (int i = 0; i < lightLabels.length; i++) {
            ...
            lightLabels[i] = new Label(lab, Color.BLACK, labelCoord);
     ...
     * default.
     *
     * @param _lightLabelnames Array of string containing the labels. When the
     * end of the array is reached for one tick, the following tick starts with
     ...
     *
     * @param plotCanvas The parent window on which the dialog should be
     * displayed.
     */
