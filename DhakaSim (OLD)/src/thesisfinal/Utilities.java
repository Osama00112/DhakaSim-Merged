...
class Utilities {
    ...
    static double getCarLength(int type) {
        double[] carLengths = {1.9, 2.4, 2.5, 1.8, 5, 4.55, 4.3, 2.65, 10.3, 9.5, 7.2, 7.5};
    ...
    static double getCarMaxSpeed(int type) {
        double[] carSpeeds = {15, 8, 7, 100, 100, 60, 110, 40, 30, 40, 35, 45}; // km/hour
    ...
    static double getCarAcceleration(int type) {
        ...
        double[] carAccelerations = {0.42, 0.25, 0.20, 2.80, 3, 2.80, 3.34, 1.11, 0.84, 1.12, 0.96, 1.24};
